...
const defaultColumn = [
  ...
  { label_en: i18n.messages.en.menu.component_name, label_bn: i18n.messages.bn.menu.component_name, class: 'text-left', sortable: true, stickyColumn: true, show: '1', order: 2, thStyle: { width: '70%' } },
