            ...
            <b-row>
              <b-col lg="12" sm="12">
                <b-overlay :show="loading">
                  ...
                  <b-row class="m-4">
                    <b-col md="6" lg="6">No. - BFTI/Admin (Monthly Meeting)/2021    </b-col>
                  ...
                  <b-row>
                    <b-col md="12 text-center">
                      <span class="badge badge-white text-dark font-weight-bold card-title"><h5>
                        {{ detailsData[0].meeting_title_en }} <br />
                        {{ detailsData[0].venue_en }} <br />
                        Date: {{ formatted(detailsData[0].meeting_date) }}
                        </h5></span>
                    </b-col>
                    <b-col lg="12" sm="12" class="m-4">
                      <div>
                        <p class="text-weight-bold"> {{ $t('systemActivityManage.agenda') }}: <br /> </p>
                        <p class="text-dark pl-4" v-html="detailsData[0].agenda_text_en"></p>
                        <!-- <b-col md="12 text-center">
                        ...
                        <b-table-simple hover small caption-top responsive striped bordered>
                          ...
                          <template v-for="(head, index) in detailsData[0].heads">
                            <slot v-for="(detail, index1) in head.details">
                              ...
                              <b-tr>
                                ...
                                <b-td> {{ detail.employee_user_id }} </b-td>
                              </b-tr>
                            </slot>
                          </template>
                        </b-table-simple>
...
export default {
  ...
  methods: {
    ...
    pdfExport () {
      ...
      ExportPdf.exportPdfDetails(bazarMonitoringServiceBaseUrl, '/configuration/report-head/detail', 11, reportTitle, this, this.detailsData, this.todayDate(), this.formatted(this.detailsData[0].meeting_date))
    },
    formatted (value) {
