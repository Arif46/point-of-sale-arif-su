...
import { cipApplicationDescriptionStoreApi, getIncomeGrowthApi } from '../../api/routes'
    ...
    methods: {
        ...
        async getIncomeGrowth (yearId) {
            ...
            if (index === 0 && typeof product === 'undefined') {
                ...
                const result = await RestApi.getData(exportTrophyCIPServiceBaseUrl, getIncomeGrowthApi, this.prod_details)
                if (result.success) {
        ...
        async submit () {
            if (this.descriptions.length > 1) {
              ...
              const result = await RestApi.postData(exportTrophyCIPServiceBaseUrl, cipApplicationDescriptionStoreApi, myObj)
