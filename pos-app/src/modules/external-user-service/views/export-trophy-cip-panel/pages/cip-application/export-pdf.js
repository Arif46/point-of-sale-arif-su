    ...
    try {
        ...
        const topRows = [
          ...
          [
            ...
            { text: vm.$t('externalUser.cip_application_type'), bold: true, style: 'td' },
            { text: vm.getAppType(vm.application.app_type), style: 'td' }
          ],
          [
            { text: vm.$t('externalUser.latent_exporter'), bold: true, style: 'td' },
            { text: vm.getLatentExporter(vm.application.latent_exporter), style: 'td', colSpan: '3' },
            {},
            {}
          ],
          [{}, {}, {}, {}],
          [{}, {}, {}, {}],
          [
            { text: vm.$t('externalUser.cip_applicants') + ' ' + vm.$t('globalTrans.information'), colSpan: '4', bold: true, style: 'mytd' },
            {},
            {},
            {}
          ],
          [
            { text: vm.$t('externalUser.cip_applicants') + ' ' + vm.$t('globalTrans.name'), bold: true, style: 'td' },
            { text: vm.currentLocale === 'bn' ? vm.application.name_bn : vm.application.name_en, style: 'td' },
            { text: vm.$t('globalTrans.father_name'), bold: true, style: 'td' },
            { text: vm.currentLocale === 'bn' ? vm.application.father_name_bn : vm.application.father_name_en, style: 'td' }
          ],
          [
            { text: vm.$t('globalTrans.mother_name'), bold: true, style: 'td' },
            { text: vm.currentLocale === 'bn' ? vm.application.mother_name_bn : vm.application.mother_name_en, style: 'td' },
            { text: vm.$t('globalTrans.gender'), bold: true, style: 'td' },
            { text: vm.genderName(vm.application.gender), style: 'td' }
          ],
          [
            { text: vm.$t('globalTrans.dob'), bold: true, style: 'td' },
            { text: vm.$d(new Date(vm.application.dob)), style: 'td' },
            { text: vm.$t('globalTrans.nid'), bold: true, style: 'td' },
            { text: vm.$n(vm.application.nid, { useGrouping: false }), style: 'td' }
          ],
          [{}, {}, {}, {}],
          [{}, {}, {}, {}],
          [
            { text: vm.$t('externalUser.cip_applicants') + ' ' + vm.$t('externalUser.passport') + ' ' + vm.$t('globalTrans.information'), colSpan: '4', bold: true, style: 'mytd' },
            {},
            {},
            {}
          ],
          [
            ...
            { text: vm.application.passport_info.passport_no, style: 'td' },
          ...
          [{}, {}, {}, {}],
          [
            { text: vm.$t('externalUser.cip_applicants') + ' ' + vm.$t('externalUser.tax') + ' ' + vm.$t('globalTrans.information'), colSpan: '4', bold: true, style: 'mytd' },
            {},
            {},
            {}
          ],
          ...
          [{}, {}, {}, {}],
          [
            { text: vm.$t('externalUser.cip_applicants') + ' ' + vm.$t('externalUser.contact') + ' ' + vm.$t('globalTrans.information'), colSpan: '4', bold: true, style: 'mytd' },
            {},
            {},
            {}
          ],
        ...
        if (vm.application.address !== null) {
          pdfContent.push({ text: '', marginBottom: 3 })
          pdfContent.push({ text: vm.$t('externalUser.cip_applicants') + ' ' + vm.$t('globalTrans.address'), style: 'my_title' })
          const Address = [
            [
        ...
        if (vm.application.org_info !== null) {
          pdfContent.push({ text: '', marginBottom: 3 })
          pdfContent.push({ text: vm.$t('externalUser.org_info'), style: 'my_title' })
          const OrgInfo = [
            [
              { text: vm.$t('externalUser.owner_name'), bold: true, style: 'td' },
              { text: vm.currentLocale === 'bn' ? vm.application.org_info.owner_name_bn : vm.application.org_info.owner_name_en, style: 'td' },
            ...
            [
              ...
              { text: vm.currentLocale === 'bn' ? vm.application.org_info.designation_bn : vm.application.org_info.designation_en, style: 'td' },
        ...
        // Tab-4: Group based data
        if (vm.application.group_based_app.length > 0) {
          pdfContent.push({ text: '', marginBottom: 3 })
          pdfContent.push({ text: vm.$t('externalUser.group_based') + ' ' + vm.$t('globalTrans.information'), style: 'my_title' })
          const Group = [
            [
              { text: vm.$t('externalUser.applied_group_of_companies'), bold: true, style: 'td', colSpan: '3' },
              {},
              {},
              { text: parseInt(vm.application.applied_group_of_companies) === 1 ? (vm.currentLocale === 'en' ? 'Yes' : 'হ্যাঁ') : (vm.currentLocale === 'en' ? 'No' : 'না'), style: 'td' }
            ],
            [{}, {}, {}, {}]
          ]
          pdfContent.push({
          ...
          if (vm.application.group_based_app.length > 0 && parseInt(vm.application.applied_group_of_companies) === 1) {
            const GroupDetails = [
              [
                { text: vm.$t('externalUser.group_based_application_data'), colSpan: '4', bold: true, style: 'mytd' },
                {},
                {},
                {}
              ],
              [
                ...
                { text: vm.$t('externalUser.group_name'), style: 'th', alignment: 'center' },
                { text: vm.$t('externalUser.group_org_name'), style: 'th', alignment: 'center' },
                { text: vm.$t('externalUser.export_value'), style: 'th', alignment: 'center' }
              ]
            ]
            vm.application.group_based_app.forEach((item, index) => {
              GroupDetails.push([
                ...
                { text: vm.$n(item.export_value, { useGrouping: false }), style: 'td', alignment: 'center' }
              ])
            })
            pdfContent.push({
              table: {
        ...
        if (vm.application.product_success_description.length > 0) {
          ...
          const Description = [
            [
              ...
              { text: vm.$t('globalTrans.year'), style: 'th', alignment: 'center' },
          ...
          vm.application.product_success_description.forEach((item, index) => {
            Description.push([
              ...
              { text: vm.$n(item.year, { useGrouping: false }), style: 'td', alignment: 'center' },
        ...
        if (vm.application.other_compliance !== null) {
          ...
          const CipSelected = [
            ...
            [{}, {}, {}, {}],
            [
              { text: vm.$t('externalUser.applicant_selected_cip_past_year'), bold: true, style: 'td', colSpan: '3' },
              {},
              {},
              { text: parseInt(vm.application.other_compliance.applicant_selected_cip_past_year) === 1 ? (vm.currentLocale === 'en' ? 'Yes' : 'হ্যাঁ') : (vm.currentLocale === 'en' ? 'No' : 'না'), style: 'td' }
            ],
            [{}, {}, {}, {}]
          ]
          pdfContent.push({
          ...
          // add export product details
          if (parseInt(vm.application.other_compliance.applicant_selected_cip_past_year) === 1) {
            const Item3 = [
              [
                { text: vm.$t('globalTrans.sl_no'), style: 'th', alignment: 'center' },
            ...
            vm.application.cip_selected.forEach((item, index) => {
              Item3.push([
                { text: vm.$n(index + 1), style: 'td', alignment: 'center' },
        ...
        pdfMake.createPdf(docDefinition, null, null, null).print() // 'cip-application')
    } catch (error) {
      if (error) {}
    }
    Store.commit('mutateCommonProperties', {
