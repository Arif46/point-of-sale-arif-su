...
use App\Http\Validations\ProductManagement\SizeValidation;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Models\ProductManagement\Size;
...
class SizeController extends Controller
{
     ...
     {
        // set the model
        $this->model = new Repository($size);
     }
     ...
     */
     ...
     {
         $validationResult = SizeValidation::validate($request);
         ...
         if ($data['success']) {
             Cache::store('redis')->forget('sizes');
             App::make('sizeList');
         }
     ...
     */
     ...
     {
        $validationResult = SizeValidation::validate($request, $id);
