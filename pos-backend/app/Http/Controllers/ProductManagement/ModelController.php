...
use App\Http\Validations\ProductManagement\ModelValidation;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Models\ProductManagement\ProductModel;
...
class ModelController extends Controller
{
    ...
    public function __construct(ProductModel $pmodel)
    {
        // set the model
        $this->model = new Repository($pmodel);
    }
    ...
    */
    ...
    {
        $validationResult = ModelValidation::validate($request);
        ...
        if ($data['success']) {
           Cache::store('redis')->forget('models');
           App::make('modelList');
        }
    ...
    */
    ...
    {
        $validationResult = ModelValidation::validate($request, $id);
