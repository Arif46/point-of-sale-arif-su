...
use App\Http\Validations\Address\BanKValidations;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Models\Address\Bank;
...
class BankController extends Controller
{
    ...
    {
        // set the model
        $this->model = new Repository($bank);
    }
    ...
    */
    ...
    {
        $validationResult = BanKValidations::validate($request);
    ...
    */
    ...
    {
        $validationResult = BanKValidations::validate($request, $id);
